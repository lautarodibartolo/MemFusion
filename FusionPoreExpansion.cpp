...
namespace PLMD
{
    namespace colvar
    {
        class fusionPoreExpansion : public Colvar
        {
            std::vector<AtomNumber> UMEM, LMEM, TAILS, WATERS, POXYGENS;
            std::vector<double> NSMEM, DSMEM, HMEM, VO, D, H, RMAX, R0, XCYL, YCYL;

        public:
            explicit fusionPoreExpansion(const ActionOptions &);
            void calculate() override;
            static void registerKeywords(Keywords &keys);
        };

        PLUMED_REGISTER_ACTION(fusionPoreExpansion, "FUSIONPOREEXPANSION")

        void fusionPoreExpansion::registerKeywords(Keywords &keys)
        {
            ...
            keys.add("atoms", "WATERS", "all the intraorganelle water beads of the system.");
            ...
            keys.add("optional", "VO", "molecular volume of water.");
            keys.add("optional", "D", "horizontal layer thickness.");
            keys.add("optional", "H", "parameter of the step function θ(x,h) for the CV.");
            keys.add("optional", "RMAX", "to avoid membrane undulations in large membranes (more than 256 lipids).");
            keys.add("optional", "R0", "to avoid membrane undulations in large membranes (more than 256 lipids).");
        ...
        fusionPoreExpansion::fusionPoreExpansion(const ActionOptions &ao) : PLUMED_COLVAR_INIT(ao)
        {
        ...
        void fusionPoreExpansion::calculate()
        {
            /*************************
            *                        *
            *         System         *
